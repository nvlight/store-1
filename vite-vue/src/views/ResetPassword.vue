<template>
    <GuestLayout title="Установка нового пароля">
        <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="-space-y-px rounded-md shadow-sm">
                ...
                <div>
                    <label for="password-confirmation" class="sr-only">Пароль</label>
                    <input id="password-confirmation" name="password-confirmation" type="password" autocomplete="current-password" required=""
